...
INSERT INTO `sys_role` (`id`, `name`, `code`, `remark`, `status`, `modified`, `created`) VALUES (1,'超级管理员','admin','系统默认最高权限，不可以编辑和任意修改',0,'2021-01-17 15:50:45','2021-01-16 13:29:03'),(2,'普通用户','normal','只有基本查看功能',0,'2021-01-30 08:19:52','2021-01-04 10:09:14');
...
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`) VALUES (60,1,1),(61,1,2),(62,1,9),(63,1,10),(64,1,11),(65,1,12),(66,1,13),(67,1,3),(68,1,7),(69,1,14),(70,2,15),(71,2,16),(72,2,4),(73,2,17),(74,2,18),(75,1,19),(76,1,5),(77,1,6),(96,1,1),(97,1,2),(98,1,3),(99,1,4),(100,1,5),(101,1,6);
...
INSERT INTO `sys_user` (`id`, `username`, `password`, `email`, `mobile`, `avatar`, `status`, `modified`, `created`) VALUES (1,'admin','123456','123456@qq.com','12345678901','https://raw.githubusercontent.com/halavah/PinGo/master/avatar/01.jpg',0,'2021-01-16 16:57:32','2021-01-12 22:13:53'),(2,'test02','123456','159263@qq.com','12345678901','https://raw.githubusercontent.com/halavah/PinGo/master/avatar/02.jpg',0,'2021-01-30 08:55:57','2021-01-30 08:20:22'),(3,'test03','123456','123457@qq.com','15926347996','https://raw.githubusercontent.com/halavah/PinGo/master/avatar/02.jpg',0,'2021-01-30 08:55:57','2021-01-30 08:20:22');
...
CREATE TABLE `sys_user_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户_角色';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_role` (`id`, `user_id`, `role_id`) VALUES (1,1,1),(2,1,2),(3,2,3),(4,2,3);
...
-- Dump completed on 2021-07-03 16:43:28
