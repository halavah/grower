...
INSERT INTO `m_user` (`id`, `username`, `password`, `email`, `mobile`, `point`, `sign`, `gender`, `wechat`, `vip_level`, `birthday`, `comment_count`, `post_count`, `avatar`, `status`, `lasted`, `created`, `modified`) VALUES (1,'admin','e10adc3949ba59abbe56e057f20f883e','11111@qq.com','13599998888',100,'Don\'t let joy take you down !\n                                    \n                                    \n                                    \n                                    \n                                    \n                    \n   ','0','visions',0,'2020-10-19 20:23:27',2,20,'/upload/avatar/avatar_1.jpg',0,'2021-03-09 13:19:00','2020-04-28 14:37:24','2020-12-08 12:25:11'),(2,'admin2','e10adc3949ba59abbe56e057f20f883e','22222@qq.com','13599998888',200,'勿因喜而轻诺！','0','visions',1,'2020-12-08 12:23:34',3,30,'/res/images/avatar/02_0051.jpg',0,'2020-12-08 12:24:22','2020-04-28 14:45:07','2020-12-08 12:25:12'),(3,'admin3','e10adc3949ba59abbe56e057f20f883e','33333@qq.com','13599998888',300,'勿因喜而轻诺！','1','visions',0,'2020-12-08 12:23:36',4,40,'/res/images/avatar/03_0053.jpg',1,'2020-12-08 12:24:23','2020-04-28 14:48:26','2020-12-08 12:25:13'),(4,'admin4','e10adc3949ba59abbe56e057f20f883e','44444@qq.com','13599998888',400,'勿因喜而轻诺！','0','visions',1,'2020-12-08 12:23:37',5,50,'/res/images/avatar/04_0054.jpg',0,'2020-12-08 12:24:25','2020-04-28 14:48:26','2020-12-08 12:25:14'),(5,'admin5','e10adc3949ba59abbe56e057f20f883e','55555@qq.com','13599998888',500,'勿因喜而轻诺！','1','visions',0,'2020-12-08 12:23:37',6,60,'/res/images/avatar/05_0056.jpg',0,'2020-12-08 12:24:26','2020-04-28 14:53:49','2020-12-08 12:25:15'),(6,'halavah','e10adc3949ba59abbe56e057f20f883e','halavah@126.com',NULL,0,NULL,'0',NULL,0,NULL,0,0,'/res/images/avatar/default.jpg',0,'2021-03-06 14:00:44','2021-03-06 14:00:30',NULL);
...
CREATE TABLE `m_user_message` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `from_user_id` bigint(20) NOT NULL COMMENT '我的消息的【发送消息的用户ID】',
  `to_user_id` bigint(20) NOT NULL COMMENT '我的消息的【接收消息的用户ID】',
  `post_id` bigint(20) DEFAULT NULL COMMENT '我的消息的【关联的文章ID】',
  `comment_id` bigint(20) DEFAULT NULL COMMENT '我的消息的【关联的文章-对应的评论ID】',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '我的消息的【关联的文章-对应的评论ID-评论的内容CONTENT】',
  `type` tinyint(2) DEFAULT NULL COMMENT '我的消息的【消息的类型】：0代表系统消息、1代表评论的文章、2代表评论的评论',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='我的消息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_user_message` (`id`, `from_user_id`, `to_user_id`, `post_id`, `comment_id`, `content`, `type`, `created`, `modified`, `status`) VALUES (1,1,2,3,2,'评论2评论2评论2评论2评论2评论2',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1),(2,2,1,4,3,'评论3评论3评论3评论3评论3评论3',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1),(3,1,3,5,4,'评论4评论4评论4评论4评论4评论4',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1),(4,3,4,4,5,'评论5评论5评论5评论5评论5评论5',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1),(5,2,3,8,6,'评论6评论6评论6评论6评论6评论6',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1),(6,2,1,10,7,'评论7评论7评论7评论7评论7评论7',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1),(7,4,5,11,8,'评论8评论8评论8评论8评论8评论8',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1),(8,5,4,12,9,'评论9评论9评论9评论9评论9评论9',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1),(9,1,3,1,1,'评论1评论1评论1评论1评论1评论1',1,'2021-03-09 22:56:48','2021-03-09 22:56:52',1);
...
-- Dump completed on 2021-03-09 23:51:22
